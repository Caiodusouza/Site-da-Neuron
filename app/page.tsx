...
import { BookOpen, Brain, Gamepad2, PenTool, StarIcon, Sparkles, Zap, Globe } from 'lucide-react'
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark' : ''}`}>
      <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900">
        ...
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-800 dark:to-indigo-800 py-20 md:py-32 pb-36 overflow-hidden">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-[-80px]">
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button size="lg" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-purple-600 transition-colors duration-300">
                      Saiba mais
                    </Button>
                  </motion.div>
                </div>
